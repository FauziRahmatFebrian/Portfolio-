...
const Hero = () => {
  ...
  return (
    <section className="min-h-screen flex flex-col items-center justify-center relative overflow-hidden">
      ...
      <div 
        ref={headerRef}
        className={`text-center z-10 px-4 mb-8 scroll-animate ${headerVisible ? 'animate' : ''}`}
      >
      ...
      {/* Profile Photo - Moved below header */}
      <div 
        ref={photoRef}
        className={`mb-8 flex justify-center scroll-animate-scale ${photoVisible ? 'animate' : ''}`}
      >
      ...
      <div 
        ref={contentRef}
        className={`text-center z-10 px-4 scroll-animate ${contentVisible ? 'animate' : ''}`}
      >
